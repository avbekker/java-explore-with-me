DROP TABLE IF EXISTS USERS, CATEGORIES, COMPILATIONS, EVENTS, REQUESTS, EVENT_COMPILATION, COMMENTS;
...
(
    ...
    CONSTRAINT "EVENT_COMP_EVENT_ID" FOREIGN KEY (EVENT_ID) REFERENCES EVENTS,
    CONSTRAINT "EVENT_COMP_COMPILATION_ID" FOREIGN KEY (COMPILATION_ID) REFERENCES COMPILATIONS
);
...
(
    ...
    CONSTRAINT "EVENT_COMMENT" FOREIGN KEY (EVENT_ID) REFERENCES EVENTS,
    CONSTRAINT "USER_COMMENT" FOREIGN KEY (CREATOR_ID) REFERENCES USERS
);